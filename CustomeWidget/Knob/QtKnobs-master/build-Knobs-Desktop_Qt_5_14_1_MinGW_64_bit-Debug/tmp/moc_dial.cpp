...
#include <memory>
#include "../../QtKnobs-master/QtKnobs/common/dial.h"
...
void Dial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Dial::*)(QColor );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Dial::colorChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Dial::*)(QColor );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Dial::borderColorChanged)) {
                *result = 1;
                return;
            }
        }
