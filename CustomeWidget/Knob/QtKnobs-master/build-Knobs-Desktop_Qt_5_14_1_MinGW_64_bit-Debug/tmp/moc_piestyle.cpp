...
#include <memory>
#include "../../QtKnobs-master/QtKnobs/styles/piestyle.h"
...
void PieStyle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PieStyle *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (PieStyle::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PieStyle::valueChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PieStyle::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PieStyle::multiColorChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (PieStyle::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PieStyle::minValueChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (PieStyle::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PieStyle::maxValueChanged)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (PieStyle::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PieStyle::readOnlyChanged)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (PieStyle::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PieStyle::percentChanged)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (PieStyle::*)(Mode );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PieStyle::modeChanged)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (PieStyle::*)(QColor );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PieStyle::colorChanged)) {
                *result = 7;
                return;
            }
        }
        {
            using _t = void (PieStyle::*)(CapStyle );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PieStyle::styleChanged)) {
                *result = 8;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject PieStyle::staticMetaObject = { {
    QMetaObject::SuperData::link<QQuickPaintedItem::staticMetaObject>(),
    qt_meta_stringdata_PieStyle.data,
    qt_meta_data_PieStyle,
    qt_static_metacall,
    nullptr,
    nullptr
} };
